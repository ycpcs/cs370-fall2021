...
**Written Questions Due: Thursday, Sept 23rd by 12:30/2:00 PM** (in class)

**Program Due:**

**Milestone 1: Monday, Sept 20th by 11:59 PM** 

**Milestone 2: Monday, Sept 27th by 11:59 PM** Late assignments will be penalized 20 points per day.

## Getting Started

Download [CS370\_Assign02.zip](src/CS370_Assign02.zip), saving it into the **CS370-Fall2021** directory.
...
> Use the provided models for a cube, cylinder, torus, and cone to draw all the geometry. You will need to load the models from their respective files in **build\_geometry()**, a **load\_color\_object()** function is provided. The objects can then be rendered using the provided **draw\_color\_object()** function.
>
> Create color buffer objects for each different colored primitive model shape you need, a **build\_color\_buffer()** function is provided.
>
