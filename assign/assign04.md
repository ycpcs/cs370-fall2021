...
**Written Questions Due: Tues, Nov 16th by 12:30/2:00 PM** (in class)

**Program Due:**

**Milestone 1: Friday, Nov 5th by 11:59 PM** 

**Milestone 2: Wednesday, Nov 17th by 11:59 PM** Late assignments will be penalized 20 points per day.

## Getting Started

Download [CS370\_Assign04.zip](src/CS370_Assign04.zip), saving it into the **CS370-Fall2021** directory.

Double-click on **CS370\_Assign04.zip** and extract the contents of the archive into a subdirectory called **CS370\_Assign04**

Open CLion, select **CS370-Fall2021** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Assign04** subdirectory). Uncomment the line
...
>
> -  Set the last parameter in **set\_materials()** to **true** for translucent objects.
>
