...
Download [CS370\_Lab08.zip](src/CS370_Lab08.zip), saving it into the **CS370** directory.

Double-click on **CS370\_Lab08.zip** and extract the contents of the archive into a subdirectory called **CS370\_Lab08**

Open CLion, select **CS370** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Lab08** subdirectory). Uncomment the line
...
Download [CS370\_Lab08\_Solution.zip](sol/CS370_Lab08_Solution.zip), saving it into the **CS370** directory.
...
Open CLion, select **CS370** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Lab08\_Solution** subdirectory). Uncomment the line
