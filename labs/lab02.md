...
Download [CS370\_Lab02.zip](src/CS370_Lab02.zip), saving it into the **CS370\_Labs** directory.

Double-click on **CS370\_Lab02.zip** and extract the contents of the archive into a subdirectory called **CS370\_Lab02**

Open CLion, select **CS370\_Labs** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Lab02** subdirectory). Uncomment the line
...
Download [CS370\_Lab02\_Solution.zip](sol/CS370_Lab02_Solution.zip), saving it into the **CS370\_Labs** directory.
...
Open CLion, select **CS370\_Labs** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Lab02\_Solution** subdirectory). Uncomment the line
...
- Add code to **build\_geometry()** to bind the *second* element (*IndexBuffer*) from the *ObjBuffers* array for the *Hexagon* element. **Hint:** The *Obj\_Buffer\_IDs* enum will contain a list of symbolic constants indexing the *ObjBuffers* array.
